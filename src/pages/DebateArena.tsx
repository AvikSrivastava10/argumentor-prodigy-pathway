          ...
          <>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {practiceOptions.map((option, index) => (
                <Card key={index} className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all group cursor-pointer">
                  <CardHeader>
